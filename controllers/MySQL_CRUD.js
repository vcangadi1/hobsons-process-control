...
exports.update = (req, res) => {
    ...
    // Insert into brew table
    db.query(`UPDATE brew SET brewer='${brewer}', beer='${beer}', gyle='${gyle}', date='${date}', fv='${fv}', mashIn='${mashIn}', copperUp='${copperUp}', mashTemp='${mashTemp}', gravity_after_boil='${gravity_after_boil}', setTaps='${setTaps}', dip_after_boil='${dip_after_boil}', first_runnings='${first_runnings}', dip_in_liquor='${dip_in_liquor}', last_runnings='${last_runnings}', wort_pH='${wort_pH}', collection_dip='${collection_dip}', issue_no='${issue_no}', action_mashing_liquor='${action_mashing_liquor}', action_glass_audit='${action_glass_audit}', action_racking_tank='${action_racking_tank}', action_fermenter='${action_fermenter}', action_auger_grain_chute='${action_auger_grain_chute}', action_trailer='${action_trailer}', action_premasher='${action_premasher}', action_mash_tun_plates='${action_mash_tun_plates}', action_copper='${action_copper}', action_pipes_paraflow='${action_pipes_paraflow}', hoursFermentation='${hoursFermentation}', tempFermentation='${tempFermentation}', gravityFermentation='${gravityFermentation}', tasteFermentation='${tasteFermentation}' WHERE id=${id}`, (err, results) => {
        if (err) {
            throw err;
        }
        _this.read(req, res);
